		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order FreeStyle",
									"targetURL": "#opensapordersf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapordersf-display": {
								"semanticObject": "opensapordersf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.ordersf",
									"url": sap.ui.require.toUrl("opensap/ordersf")
								}
							}
						}
					}
