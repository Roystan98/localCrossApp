		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers List Freestyle",
									"targetURL": "#opensapcustomersf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapcustomersf-display": {
								"semanticObject": "opensapcustomersf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.customersf",
									"url": sap.ui.require.toUrl("opensap/customersf")
								}
							}
						}
					}
